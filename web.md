...
###  基本
役割3 × ハード・ソフト2の「6マスマップ」

| 役割 | ハードウェア（物理的な実体） | ソフトウェア（論理的な仕組み・プログラム） |
| --- | --- | --- |
| コンピューター<br>（処理・記憶） | CPU、メモリ、SSD、物理サーバー、ハードディスク など | OS（Linux/Windows）、データベース、バックエンドプログラム（Python/Rubyなど） |
| ネットワーク<br>（伝送・通信） | LANケーブル、ルーター、Wi-Fi機器、光ファイバー など | HTTP/HTTPS、TCP/IP、DNS、API、各種通信プロトコル |
| インターフェース<br>（入出力） | モニター、マウス、キーボード、スマホの画面（タッチパネル） など | ブラウザ、HTML、CSS、JavaScript（フロントエンド）、UIデザイン |
